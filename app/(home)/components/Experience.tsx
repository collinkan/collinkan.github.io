    ...
    const data = [
        {
            ...
            content: (
                <div>
                    <h3 className="text-4xl font-bold tracking-wide mb-2">Software Engineer</h3>
                    <p className="text-2xl italic text-synthTeal mb-4">Visa Inc. • Bellevue, WA</p>
                    <ul className="list-disc pl-4 text-xl font-medium space-y-2">
        ...
        },
        {
            ...
            content: (
                <div>
                    <h3 className="text-4xl font-bold tracking-wide mb-2">Software Engineer</h3>
                    <p className="text-2xl italic text-synthTeal mb-4">Deloitte • Gilbert, AZ</p>
                    <ul className="list-disc pl-4 text-xl font-medium space-y-2">
        ...
        },
        {
            ...
            content: (
                <div>
                    <h3 className="text-4xl font-bold tracking-wide mb-2">Software Engineer Intern</h3>
                    <p className="text-2xl italic text-synthTeal mb-4">Amazon • Toronto, ON, Canada</p>
                    <ul className="list-disc pl-4 text-xl font-medium space-y-2">
        ...
        },
        {
            ...
            content: (
                <div>
                    <h3 className="text-4xl font-bold tracking-wide mb-2">Software Engineer Intern</h3>
                    <p className="text-2xl italic text-synthTeal mb-4">SequoiaDB • Markham, ON, Canada</p>
                    <ul className="list-disc pl-4 text-xl font-medium space-y-2">
        ...
        },
        {
            ...
            content: (
                <div>
                    <h3 className="text-4xl font-bold tracking-wide mb-2">Undergraduate Teaching Assistant</h3>
                    <p className="text-2xl italic text-synthTeal mb-4">McMaster University • Hamilton, ON, Canada</p>
                    <ul className="list-disc pl-4 text-xl font-medium space-y-2">
